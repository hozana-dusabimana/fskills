// Responsible for drawing game elements on the screen
'use strict';
...
function initSprites()
{
    ...
    PB(spriteList.sign_RP31K     = new GameSprite(vec3(0,2),600,0,.02,1,0));
    ...
    // obstacles
    spriteList.cone = new GameSprite(vec3(5,5), 1200, 0, 0, .5, 0);
    spriteList.cone.colorHSL = vec3(.08, 1, .6);
    spriteList.cone.spriteYOffset = -0.02;
    spriteList.pothole = new GameSprite(vec3(6,5), 1400, 0, 0, .18, 0);
    spriteList.pothole.colorHSL = vec3(0, 0, .1);
    spriteList.pothole.spriteYOffset = -0.02;
    spriteList.roadblock = new GameSprite(vec3(7,5), 1800, 0, 0, .25, 0);
    spriteList.roadblock.colorHSL = vec3(.13, 1, .5);
    spriteList.roadblock.spriteYOffset = -0.02;
}
