// Contains definitions and data for game levels
'use strict';
...
function mapLevelToDesiredLevel(level) {
...
const getLevelInfo = (level) => {
    const mappedLevel = mapLevelToDesiredLevel(level);
    return testLevelInfo || levelInfoList[mappedLevel] || levelInfoList[0];
}
